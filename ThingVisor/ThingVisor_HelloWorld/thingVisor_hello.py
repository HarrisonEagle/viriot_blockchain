...
class MqttControlThread(Thread):
    ...
    def run(self):
        ...
        print("Published Topic:" + tv_control_prefix + "/" + thing_visor_ID + "/" + out_control_suffix)
        print("Contents:" + json.dumps(v_thing_message))
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(MQTT_data_broker_IP)
        print(MQTT_control_broker_IP)
        print(parameters)
        if parameters:
