...
kubectl create namespace ${TEST_NETWORK_NAMESPACE:-viriot-network}
...
aliases (e.g. grpcs://org1-peer1.viriot-network.svc.cluster.local:443) and traverse private K8s network routes.
