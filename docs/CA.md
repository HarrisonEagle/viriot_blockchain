...
Launching network "viriot-network":
...
...
kubectl -n viriot-network apply -f kube/org0/org0-tls-cert-issuer.yaml
kubectl -n viriot-network apply -f kube/org1/org1-tls-cert-issuer.yaml
kubectl -n viriot-network apply -f kube/org2/org2-tls-cert-issuer.yaml
```
...
```shell
kubectl -n viriot-network apply -f kube/org0/org0-ca.yaml
kubectl -n viriot-network apply -f kube/org1/org1-ca.yaml
kubectl -n viriot-network apply -f kube/org2/org2-ca.yaml
```
